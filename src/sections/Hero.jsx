      ...
      <div className="hero-container">
        <div className="hero-content-grid">
          <div className="hero-copy-block">
            <p className="hero-reveal hero-eyebrow">
              Rudranil Mondal · Software Engineering Portfolio
            </p>
            ...
            <p className="hero-reveal hero-copy">
              Software engineer focused on full-stack development, artificial
              intelligence, and strong computer science fundamentals. I build
              intelligent applications using React, FastAPI, LLMs, and modern
              engineering practices — from idea to deployment.
            </p>
            ...
            <div className="hero-reveal hero-metrics">
              <div>
                <strong>3+</strong>
                <span>AI Applications Built</span>
              </div>
              <div>
                <strong>350+</strong>
              ...
              <div>
                <strong>9.2</strong>
                <span>CGPA in CSE,NIT Durgapur</span>
              </div>
            </div>
          </div>
          ...
          <figure
            ...
            aria-label="Interactive developer workspace model"
          >
